...
namespace MyMusic.Model
{
    public class PlayingSongForSqlModel : INotifyPropertyChanged
    {
        ...
        public PlayingSongForSqlModel(string id,string picUrl,string url,string name,string artist,long duration, int like,int playing,string alName,string lyric)
        {
            this._id = id;
            this._picUrl = picUrl;
            this._url = url;
